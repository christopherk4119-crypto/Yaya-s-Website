...
const socials = [
  {
    ...
    href: "https://www.tiktok.com/@yaya.electric_canada", color: SOCIAL_COLORS.tiktok,
    icon: <TikTokIcon />,
  },
  {
    name: "Instagram", handle: "@yayacalgary", desc: "Follow us on Instagram",
    href: "https://www.instagram.com/yayacalgary/", color: SOCIAL_COLORS.instagram,
    icon: <InstagramIcon />,
  },
  {
    name: "YouTube", handle: "YAYA General Service", desc: "Watch our work on YouTube",
    href: "https://www.youtube.com/channel/UCNgUCI9MK3DShuf3G_I72fg", color: SOCIAL_COLORS.youtube,
    icon: <YouTubeIcon />,
  },
  {
