...
export const metadata: Metadata = {
  title: "Dishwasher Repair Calgary | All Brands | YAYA General Contractor Inc.",
  ...
  openGraph: {
    title: "Dishwasher Repair Calgary | YAYA General Contractor Inc.",
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      <p className="text-gray-300 text-xl mb-8 leading-relaxed">
        Dishwasher leaking, not draining, or not cleaning properly? YAYA General Contractor Inc. repairs all dishwasher brands in Calgary. Fast diagnosis, clear quote before any work starts, no after-hours fee.
      </p>
