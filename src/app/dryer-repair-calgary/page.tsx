...
export const metadata: Metadata = {
  title: "Dryer Repair Calgary | All Brands | YAYA General Contractor Inc.",
  ...
  openGraph: {
    title: "Dryer Repair Calgary | YAYA General Contractor Inc.",
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      <p className="text-gray-300 text-xl mb-8 leading-relaxed">
        Dryer not heating, taking too long, or making a noise? YAYA General Contractor Inc. repairs all dryer brands in Calgary — Samsung, LG, Whirlpool, Maytag, GE, and more. Same-day available, no after-hours fee.
      </p>
