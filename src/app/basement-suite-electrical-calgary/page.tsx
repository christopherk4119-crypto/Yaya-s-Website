  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-24">
      ...
      <p className="text-gray-300 text-xl mb-8 leading-relaxed">
        Building a legal basement suite in Calgary requires electrical work done to code with proper permits. YAYA General Contractor Incorporated handles the full electrical rough-in, panel upgrades, and suite separation — everything the City of Calgary requires for a legal secondary suite.
      </p>
